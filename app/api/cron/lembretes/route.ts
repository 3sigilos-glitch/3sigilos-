...
export async function GET(request: Request) {
  ...
  // (Antes, sem segredo a rota ficava aberta e qualquer pessoa podia disparar
  // emails para a banda.) O Vercel Cron envia este cabecalho automaticamente
  // quando a variavel CRON_SECRET esta definida no projeto.
