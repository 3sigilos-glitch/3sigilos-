...
export default async function PaginaDefinicoes() {
  ...
  return (
    <section style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <AvisoAdmin>
        <strong style={{ color: 'var(--admin-forte)' }}>Zona de administracao.</strong> Esta pagina so aparece a quem e
        admin (tu e quem tiveres definido). Os outros elementos nao a veem nem conseguem alterar nada aqui.
      </AvisoAdmin>
