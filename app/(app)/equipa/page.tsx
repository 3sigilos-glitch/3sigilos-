  ...
  return (
    <section style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        {sessao.ehAdmin && (
          <Link href="/equipa/novo" className="botao" style={{ width: 'auto', background: 'var(--admin)', boxShadow: 'none' }}>Novo</Link>
        )}
      </div>
      ...
      {sessao.ehAdmin && (
        <AvisoAdmin>
          ...
          e reservado a ti. Os outros veem esta lista, mas nao a conseguem alterar.
        </AvisoAdmin>
      )}
