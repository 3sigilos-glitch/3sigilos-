...
export default function BotaoNovaEncomenda() {
  ...
  return (
    <Link
      ...
      className="fixed right-4 z-40 flex h-14 items-center gap-2 rounded-full bg-dourado px-5 font-titulo text-[15px] font-semibold tracking-wide text-fundo shadow-lg shadow-black/40 transition-colors hover:bg-dourado-claro active:scale-95"
